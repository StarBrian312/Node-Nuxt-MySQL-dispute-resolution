 ...
 * is only used in your production environment,
 ...
 * > don't add private/sensitive data
 * (like API secrets / db passwords) to this file!
 *
...
module.exports = {
  ...
  fixtures: {
    ...
    User: [
      ...
      {
        id: 2,
        email: 'timofeybiryukov@gmail.com',
        firstName: 'Timofey',
        lastName: 'Biryukov',
        role: 1
      }
  ...
  email: {
    from: 'no-reply@guidedresolution.com',
    transporter: {
      secure: false
    },
    testMode: false
  ...
  **************************************************************************/
  datastores: {
    ...
    **************************************************************************/
    default: {
      ...
      //  mysql://admin:myc00lpAssw2D@db.example.com:3306/my_prod_db
      //  ```
      //-----------------------------------------------------------------------
      ...
      *                                                                       *
      * > For example, for some hosted PostgreSQL providers (like Heroku),    *
      *  the                                                                  *
  ...
  models: {
    ...
    ************************************************************************/
    ...
    /**********************************************************************
    *                                                                     *
    * If, in production, this app has access                              *
    * to physical-layer CASCADE                                           *
    * constraints (e.g. PostgreSQL or MySQL),                             *
    * then set those up in the                                            *
    * database and uncomment this to                                      *
    * disable Waterline's `cascadeOnDestroy`                              *
    * polyfill.  (Otherwise,                                              *
    * if you are using a databse like Mongo, you might                    *
  ...
  ***************************************************************************/
  session: {
    ...
    *                                                                       *
    * > While @sailshq/connect-redis is a popular choice for Sails          *
    *   apps, many                                                          *
    * > other compatible packages (like "connect-mongo") are available      *
    *   on NPM.                                                             *
    ...
    ************************************************************************/
    ...
    // ```
    // sails_session__url=
    // redis://admin:myc00lpAssw2D@bigsquid.redistogo.com:9562/0
    // ```
    //
    //-------------------------------------------------------------------------
  ...
  ***************************************************************************/
  sockets: {
    ...
    ***********************************************************************/
    ...
    /***************************************************************
    *                                                              *
    * If you are deploying a cluster of                            *
    * multiple servers and/or processes,                           *
    * then uncomment the following lines.                          *
    * This tells Socket.io about a Redis                           *
    * server it can use to help it deliver                         *
    * broadcasted socket messages.                                 *
    *                                                              *
    * > Be sure a compatible version of                            *
    *   @sailshq/socket.io-redis is installed!                     *
    * > (See https://sailsjs.com/config/sockets                    *
    *   for the latest version info)                               *
    *                                                              *
  ...
  ***************************************************************************/
  ...
  http: {
    ...
    * (the "max-age" to include in the                                   *
    * "Cache-Control" response header)                                   *
    *                                                                    *
    * If you are caching assets with a tool                              *
    * like Cloudflare, you may want to                                   *
    * reduce this considerably to allow                                  *
    * more flexibility in purging the cache.                             *
    *                                                                    *
    *********************************************************************/
    ...
    * Proxy settings                                                *
    *                                                               *
    * If your app will be deployed                                  *
    * behind a proxy/load balancer - for example,                   *
    * on a PaaS like Heroku -                                       *
    * then uncomment the `trustProxy` setting below.                *
    * This tells Sails/Express                                      *
    * how to interpret X-Forwarded headers.                         *
    *                                                               *
    * This setting is especially                                    *
    * important if you are using secure cookies                     *
    * (see the `cookies: secure`                                    *
    * setting under `session` above) or if your app                 *
    * relies on knowing the original                                *
    * IP address that a request came from.                          *
    *                                                               *
